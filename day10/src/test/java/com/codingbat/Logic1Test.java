...
public final class Logic1Test {
	...
	public void testCigarParty() {
		...
		assertFalse(logic.cigarParty(30, true));
		assertTrue(logic.cigarParty(50, true));
		assertTrue(logic.cigarParty(60, false));
		assertFalse(logic.cigarParty(61, false));
		assertTrue(logic.cigarParty(40, false));
		assertFalse(logic.cigarParty(39, false));
		assertTrue(logic.cigarParty(40, true));
		assertFalse(logic.cigarParty(39, true));
	}
