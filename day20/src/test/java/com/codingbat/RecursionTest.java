...
public final class RecursionTest {
	...
	public void testFactorial() {
		...
		assertEquals(40320, recursion.factorial(8));
	...
	public void testBunnyEars2() {
		...
		assertEquals(7, recursion.bunnyEars2(3));
		assertEquals(10, recursion.bunnyEars2(4));
		assertEquals(12, recursion.bunnyEars2(5));
		assertEquals(15, recursion.bunnyEars2(6));
		assertEquals(25, recursion.bunnyEars2(10));
	}
	...
	public void testArray220() {
		...
		assertTrue(recursion.array220(new int[] { 1, 2, 3, 4, 4, 50, 500, 6 },
				0));
	}
	...
	public void testParenBit() {
		...
		assertEquals("(not really)",
				recursion.parenBit("hello(not really)there"));
