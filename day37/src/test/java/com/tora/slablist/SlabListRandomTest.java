...
public class SlabListRandomTest {
	private static final int ITERATION_PER_TEST = 32;
	private static final int REALLOC_TRESHOLD = 2;
	private static final int MAXIMUM_SLAB_SIZE = 16;
	...
	public SlabListRandomTest(int randSeed) {
	...
	@Before
	public void setUp() {
		lst = new SlabList<Integer>(INCREMENT, MAXIMUM_SLAB_SIZE,
				REALLOC_TRESHOLD);
