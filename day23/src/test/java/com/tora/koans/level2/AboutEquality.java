...
public final class AboutEquality {
	...
	static class Car {
		...
		public boolean equals(Object other) {
			...
			// Car objects with same horsepower and name values should be
			// considered equal
	...
	public void equalForOwnObjects() {
		...
		// See line 41 for the task you have to solve
	...
	public void ownHashCode() {
		...
		// Implement a hash code version in line 47 so that the following
		// assertions pass
		Car car1 = new Car("Beetle", 50);
		Car car2 = new Car("Beetle", 50);
		assertEquals(car1.equals(car2), true);
