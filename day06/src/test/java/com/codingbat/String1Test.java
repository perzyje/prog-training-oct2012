...
public class String1Test {
	...
	public void testMakeTags() {
		...
		assertEquals("<address>here</address>",
				string.makeTags("address", "here"));
	...
	public void testWithouEnd2() {
		assertEquals("ell", string.withouEnd2("Hello"));
		assertEquals("b", string.withouEnd2("abc"));
		assertEquals("", string.withouEnd2("ab"));
		assertEquals("", string.withouEnd2("a"));
		assertEquals("", string.withouEnd2(""));
		assertEquals("old", string.withouEnd2("coldy"));
		assertEquals("ava cod", string.withouEnd2("java code"));
	}
